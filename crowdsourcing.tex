...
Our initialization has a very nice theoretical property in that its close to the true confusion matrix for each labeller. Let us define some metrics so we can make this notion precise:
